jQuery(document).ready(function ($) {
  // Forms
  $(
    '.em-user-registration-form, .em-user-login-form, .em-change-password-form, .em-edit-profile-form'
      ...
      success: (response) => {
        ...
        if (!response.success) {
          ...
          if ('form_redirect' in response.data) {
            ...
            $('.em-form-success', this).append(
              '<small>' + response.data.success_message + '</small>'
            );
          }
        }
      },
